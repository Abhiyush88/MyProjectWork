...
public final class File {
    ...
    private String mUri;    // Naveen: Used for rtsp streaming
    ...
    // Naveen Added Constructor & getter, setter
    public File(String type, Long size, String date, String path, String name, String extension, String uri) {
        mType = type;
        mSize = size;
        mDate = date;
        mPath = path;
